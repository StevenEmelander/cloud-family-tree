...
const ICONS = {
  addPerson: 'M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3zm14-8h2v2h-2v2h-2v-2h-2v-2h2V8h2v2z',
  review: 'M9 2a1 1 0 000 2h2a1 1 0 100-2H9zM4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm5 3a1 1 0 000 2h2a1 1 0 100-2H9zm-1 4a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z',
  ...
  signOut: 'M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V4a1 1 0 00-1-1H3zm7 4.5a.5.5 0 01.5.5v2.5H13a.5.5 0 010 1h-2.5V14a.5.5 0 01-1 0v-2.5H7a.5.5 0 010-1h2.5V8a.5.5 0 01.5-.5z',
};
            ...
            <div className={styles.dropdown}>
              ...
              <div className={styles.dropdownMenu}>
                <div className={styles.menuHeader}>
                  ...
                  <span className={`${styles.menuRole} ${user.role === 'admins' ? styles.menuRoleAdmin : user.role === 'editors' ? styles.menuRoleEditor : styles.menuRoleVisitor}`}>{displayRole(user.role)}</span>
                </div>
                ...
                <div className={styles.menuGroup}>
                  <button type="button" onClick={signOut} className={`${styles.dropdownItem} ${styles.signOutItem}`}>
                    <svg className={styles.itemIcon} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
